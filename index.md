...
## Linear Regression Analysis: Sales vs. Social Media Advertising Spend

[![Run in Google Colab](https://img.shields.io/badge/Colab-Run_in_Google_Colab-blue?logo=Google&logoColor=FDBA18)](https://colab.research.google.com/drive/1BiuaPzMXjgbqZXN9IYlo-fFbGKay_da9#scrollTo=WGlR-FqI3HDu)

### Project Overview

This project demonstrates the application of linear regression to analyze the relationship between sales and social media advertising spend.

### Data Visualization

<br>
<center><img src="images/social_ads.png" width="800"/></center>
<br>
...
- The model explains 61% of the variance in sales (R² = 0.61)
- For every RM 50,000 increase in advertising budget:
  - Expected increase in units sold: 9,409
  - Projected revenue increase: RM 47,047,127.75
...
- Incorporate additional features such as seasonality, and competitor advertising spend
- Develop a dashboard for real-time sales predictions based on advertising budget input
